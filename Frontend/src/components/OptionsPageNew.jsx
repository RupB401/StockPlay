...
function OptionsPage() {
  ...
  const StrategyCard = ({ strategy }) => (
    ...
    >
      ...
      >
        <div>
          <strong>Max Profit:</strong> {strategy.maxProfit}
        </div>
        <div>
          <strong>Max Loss:</strong> {strategy.maxLoss}
        </div>
        <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div>
          ...
          >
            ...
            <div>
              <strong>Best Used When:</strong> {strategy.when}
            </div>
          </div>
        </div>
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          >
            Learn options strategies, analyze contracts, and master derivatives
            trading
          </p>
        </div>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                      ...
                      {
                        title: "Premium",
                        desc: "Cost to buy the option",
                        icon: "💰",
                        color: "blue",
                      },
                      {
                        title: "Greeks",
                        desc: "Risk metrics (Delta, Gamma, etc.)",
                        icon: "🔢",
                        color: "purple",
                      },
                    ].map((concept, i) => (
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      {
                        outlook: "Neutral",
                        strategies: ["Iron Condor", "Short Straddle"],
                      },
                      {
                      ...
                      },
                      {
                        ...
                        strategies: ["Long Put", "Put Calendar"],
                      },
                    ].map((item, i) => (
                      <div
                        key={i}
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      {
                        risk: "High Risk",
                        strategies: ["Short Options", "Naked Calls"],
                        color: "red",
                      },
                    ].map((item, i) => (
                      <div
